...
namespace pine {
    ...
    private:
        ...
        static constexpr const char* kApexGoogleArtLibDir = "/apex/com.google.android.art/lib64/";
#else
        ...
        static constexpr const char* kApexGoogleArtLibDir = "/apex/com.google.android.art/lib/";
#endif
